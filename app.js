...
const translations = {
    ar: {
        ...
        work_subtitle: "أعمال مختارة",
        work_title: "حلول حقيقية صممناها لتصنع فرقًا",
        work_intro: "من مواقع الشركات إلى الأنظمة الذكية، شاهد كيف نحوّل احتياجات عملائنا إلى تجارب رقمية متقنة.",
        work_view_all: "استكشف كل الأعمال",
        filter_all: "الكل",
    ...
    en: {
        ...
        work_title: "Real solutions, designed to make a difference",
        work_intro: "From business websites to intelligent systems, see how we turn client needs into polished digital experiences.",
        work_view_all: "Explore all projects",
        filter_all: "All",
